        ...
        <div className="row mx-3">
            <div className=" col-xs-12 col-md-12 col-lg-3 me-5 ">
               ...
               <span className="fs-4 "><ShoppingBagIcon sx={{ fontSize: 25 }}/></span> 
                ...
                <p className="text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque convallis diam in libero sagittis, ac auctor lorem gravida. Curabitur eget nisl non dolor bibendum volutpat.
